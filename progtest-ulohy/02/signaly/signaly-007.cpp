...
int main(){
	...
	long long int zaklad, koeficient,koeficientDruhy, zakladDruhy, normujiciParametr ,kDosaz, zDosaz, syncCas, a1, a2, b1, b2, zRce0, kRce0, prepinacSyncZa, tmp;
	int nacteno;
	...
	printf("prepinac sync: %lld ", prepinacSyncZa);
	...
	/*kdyz je sync za 0 nebo za konkretni cislo a bylo to tak i driv... nech to tak*/	
	} else{prepinacSyncZa = -1 ; }


	printf("prepinacSyncZa:%lld\n", prepinacSyncZa);
	}
